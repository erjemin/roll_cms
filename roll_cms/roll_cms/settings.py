...
THUMBNAIL_ALIASES = {
    '': {
        ...
        'full-HD': {'size': (1900, 1900), 'autocrop': True},
        '2k': {'size': (2540, 2540), 'autocrop': True},
        'ultra-HD': {'size': (3820, 3820), 'autocrop': True},
    },
}
...
THUMBNAIL_EXTENSION = 'webp'                 # Устанавливает расширение файла, используемое для миниатюр.
